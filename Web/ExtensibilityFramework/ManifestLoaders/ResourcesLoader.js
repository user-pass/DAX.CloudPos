System.register(["../ExtensionCultureManager", "./ManifestLoaderBase", "../ExtensionNameGenerator", "../Extension"], function (exports_1, context_1) {
    "use strict";
    ...
    var ExtensionCultureManager_1, ManifestLoaderBase_1, ExtensionNameGenerator_1, Extension_1, ResourcesLoader;
        ...
        execute: function () {
            ResourcesLoader = (function (_super) {
                ...
                ResourcesLoader.prototype.load = function (extensionPackage, resourcesManifestItem) {
                    ...
                    if (Commerce.StringExtensions.isNullOrWhitespace(resourcesManifestItem.culturesDirectoryPath)) {
                        throw "'culturesDirectoryPath' is required for 'resources' manfiest item";
                    }
                    if (Commerce.StringExtensions.isNullOrWhitespace(resourcesManifestItem.stringResourcesFileName)) {
                    ...
                    var extensionName = ExtensionNameGenerator_1.default.getResourcesExtensionName(resourcesManifestItem);
                    var correlationId = Commerce.LoggerHelper.getNewCorrelationId();
                    return ExtensionCultureManager_1.ExtensionCultureManager.instance.createResourceManager(extensionPackage, resourcesManifestItem.supportedUICultures, resourcesManifestItem.fallbackUICulture, resourcesManifestItem.culturesDirectoryPath, resourcesManifestItem.stringResourcesFileName).then(function () {
            ...
            exports_1("default", ResourcesLoader);
        }
    };
});
...
// SIG // O3hnNo3SquvbGFAuB/k4RjDomtFiillQ98nkq20qrq2g
...
// SIG // ARUwLwYJKoZIhvcNAQkEMSIEIG85rUUCKdGtic6kuBVy
// SIG // 2WROlaX1POF7U/H0JOBo36ECMGQGCisGAQQBgjcCAQwx
// SIG // VjBUoDaANABnAGwAbwBiAGEAbABpAHoAZQAuAGMAdQBs
// SIG // AHQAdQByAGUALgBsAHYALQBMAFYALgBqAHOhGoAYaHR0
// SIG // cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEB
// SIG // AQUABIIBAGXMZr1peFuS82YGSM55jaGOzOBEvBfovrDd
// SIG // OSPzf/9eCitLH1cQO5F0q1VxTgfZBUdccQG8Jdx0UmZQ
// SIG // 8e8AzaPu+IYFJXlUj/fIgWmgwlv+EGu2h0jzofnLefyh
// SIG // 36JxW68EEJ5gukCEDEeipmCtzeL5z1A6Ma8gg6FA3nNn
// SIG // 0V8oG2VZHtNNyrWKSf3ry2hMH8lanfxEl0aHvFAjRm87
// SIG // RsXWLASSSsASwOPA9LD0w4ou87CWbx57HpSyjCNET7PT
// SIG // zlrpI9w2TqYxGqn9nDZPNB4jUaFUqJZwfHmqkuc/Nj4q
// SIG // yYumZJyBTpHlHhcDCN9OLqBEGBB+RwDgdVhtyISTF1Gh
...
// SIG // CisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgQgeV
// SIG // 9nZ8xnbQgMdATtHp/LpjIhOIXiIVaM21KNxqbIcCBlx1
// SIG // QLrKLBgTMjAxOTAzMTIwOTUzMTAuNjM2WjAEgAIB9KCB
...
// SIG // DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCDkPgkwdV65NRIh
// SIG // 6RuL4OWepE1L/b992OvI4F/uwPUNrjCB+gYLKoZIhvcN
...
// SIG // j/AvvnNXQrsyMPEwDQYJKoZIhvcNAQELBQAEggEAdSN+
// SIG // S5WHB0S/qCqexK9IZOYrCNw5fi4UvgVFFm9f7nJIxFQ9
// SIG // KyLWwnj4kqZPj+0fOC4ot/5DEmQcZPzJ+RUdskLLEmjd
// SIG // v4YJDL7ZVQhdzhnS5QQnHZwX9hFPX9HUCjM5E9QKTLmS
// SIG // wq18ImUdfiWEci9dDgmbHvLZhrvBGn65JrQUN4vKSEyU
// SIG // PgNYf5Np+pv6wujs58WrAUhQH65mHeb7J4yke3sH/oRp
// SIG // dXfs2WmmMJ71l/8qmtxnlOGyRug/QsvuTGrXngZ+Ugzz
// SIG // sfjuqWgTLOXVFVbXcz2gK4MI7pCgO1Qt3tRwHc6LaIGz
// SIG // PztN7AHm9a5zs7LYEGqk8B8FLgfLHg==
