System.register(["./ManifestLoaderBase", "PosApi/Extend/RequestHandlers/RequestHandlers", "../Extension", "../ExtensionNameGenerator"], function (exports_1, context_1) {
    "use strict";
    ...
    var ManifestLoaderBase_1, RequestHandlers_1, Extension_1, ExtensionNameGenerator_1, ExtensionPointType, RequestHandlerExtensionsLoader;
        ...
        execute: function () {
            ...
            RequestHandlerExtensionsLoader = (function (_super) {
                ...
                RequestHandlerExtensionsLoader.prototype.load = function (extensionPackage, handlers) {
                    var _this = this;
                    handlers = Commerce.ObjectExtensions.isNullOrUndefined(handlers) ? [] : handlers;
                ...
                RequestHandlerExtensionsLoader.prototype._loadHandler = function (extensionPackage, handler, correlationId) {
                    ...
                    var extensionName = ExtensionNameGenerator_1.default.getReplacementRequestHandlerExtensionName(handler);
                    return this.loadModule(extensionPackage.packageInfo.baseUrl, handler.modulePath)
                        .then(function (handlerModule) {
                        if (Commerce.ObjectExtensions.isNullOrUndefined(handlerModule) || Commerce.ObjectExtensions.isNullOrUndefined(handlerModule.default)) {
                            Commerce.RetailLogger.extensibilityFrameworkInvalidModuleWhileLoadingRequestHandlerExtensions(handler.modulePath, correlationId);
                            ...
                            Commerce.RetailLogger.extensibilityFrameworkTypeMismatchWhileLoadingRequestHandlerExtensions(handler.modulePath, "ReplacementRequestHandlerBase", correlationId);
                        ...
                        return extensionPackage.context.runtime.executeAsync(request).then(function (response) {
                            if (!response.canceled) {
                                ...
                                Commerce.RetailLogger.extensibilityFrameworkRequestHandlerExtensionSuccessfullyRegistered(handler.modulePath, requestTypeName, correlationId);
                                extensionPointName = handler.modulePath + "." + requestTypeName;
                                return Promise.resolve();
                            }
                            else {
                                Commerce.RetailLogger.extensibilityFrameworkRequestHandlerExtensionFailedToRegister(handler.modulePath, Commerce.StringExtensions.EMPTY, correlationId);
                        ...
                        Commerce.RetailLogger.extensibilityFrameworkRequestHandlerExtensionFailedToRegister(handler.modulePath, Commerce.ErrorHelper.serializeError(reason), correlationId);
            ...
            exports_1("default", RequestHandlerExtensionsLoader);
        }
    };
});
//# sourceMappingURL=RequestHandlerExtensionsLoader.js.map
// SIG // Begin signature block
// SIG // MIIjpgYJKoZIhvcNAQcCoIIjlzCCI5MCAQExDzANBglg
// SIG // hkgBZQMEAgEFADB3BgorBgEEAYI3AgEEoGkwZzAyBgor
// SIG // BgEEAYI3AgEeMCQCAQEEEBDgyQbOONQRoqMAEEvTUJAC
// SIG // AQACAQACAQACAQACAQAwMTANBglghkgBZQMEAgEFAAQg
// SIG // SIZou0cqoTwSF3ETONVXFJLpC+TTm5ruOqBgpILjikyg
...
// SIG // ARUwLwYJKoZIhvcNAQkEMSIEIPgycHHqm4L6g4j1kzkK
// SIG // fD3oSEex8F+y3dQLe0jd/NbwMGQGCisGAQQBgjcCAQwx
// SIG // VjBUoDaANABnAGwAbwBiAGEAbABpAHoAZQAuAGMAdQBs
// SIG // AHQAdQByAGUALgBsAHYALQBMAFYALgBqAHOhGoAYaHR0
// SIG // cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEB
// SIG // AQUABIIBAGtkL0fCUVAn14kpAQBdLE7C2Mv/d0m84+fb
// SIG // YnHv1EpjDM2pi3fDs74zMOUMaryJwuJPuu4RezYK6p00
// SIG // w7raoh3Ha4R14gfgPgfD+urKfwPFE10iddpU0Edj4Ex4
// SIG // yY3aTcsOCASK/YgSrgDc8Sn+ZcRAF5jh8KjcwsbcugQs
// SIG // x7Q4gbiN+4t9l28JMzbXm4StOcFIdRyoDhPkd+6ZqKdg
// SIG // PYjXE5uzinU0LhI6oMZxxrO5p8m03Px5rLUx03FRirv2
// SIG // QT94taPJKaSRIE/na9zkW71fmJqeCQgQS6WP+4KU5l8G
// SIG // jWsWiWRR7zexIpqunnAngbhzvBZm866oF3UVESqf/Kqh
...
// SIG // CisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgAtjP
// SIG // nT9nL0lQLWI3j4ECS9RK4VFtG4xlQWeu/hYHbtMCBlx1
// SIG // QLrKWBgTMjAxOTAzMTIwOTUzMTIuMDg0WjAEgAIB9KCB
...
// SIG // DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCAy6pQWYxwfTjLJ
// SIG // s8UExsMS+kcFURv6qKei34LhLPnoYTCB+gYLKoZIhvcN
...
// SIG // j/AvvnNXQrsyMPEwDQYJKoZIhvcNAQELBQAEggEALrj1
// SIG // yWSLG3jIz2XYuhEmCktxMrBUciC/4Gc9iaa2hw3QBmQt
// SIG // xK2Lx29/uf7w+rKrZGJiZTSA9ljqvASSzEXfZFMc9Lmy
// SIG // Bcu2pOnWKdMtw2CenGNm27eSr2yzjeUjxZQp4Uyn6gvO
// SIG // 5ma0lrcifdJNT0lnbYHtgR7II4HTRQKzcmEakf2q9ulQ
// SIG // dUtZY0tuYlEEUbVxnVyOZ3gojfyIaOHuRDAeLrkfgzuU
// SIG // I1jo8GnGOu/Vfc4N6pgr61WnS4ug/eeSzmnjF5gUCd8J
// SIG // JT4iAxy6MCHs/M1cz/xzt7TN8+QAdLflEUlAupiiwoph
// SIG // ZAmwOW9gbvEKiLEdKC3XmZYjNrgCzw==
