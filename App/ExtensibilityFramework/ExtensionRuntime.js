System.register(["PosApi/TypeExtensions"], function (exports_1, context_1) {
    "use strict";
    var TypeExtensions_1, ExtensionRuntime;
        ...
        execute: function () {
            ExtensionRuntime = (function () {
                ...
                ExtensionRuntime.prototype.executeAsync = function (request) {
                    ...
                    var requestTypeName = TypeExtensions_1.ObjectExtensions.isNullOrUndefined(request) ? "null" : Commerce.PrototypeHelper.getPrototypeChainTypeName(request);
                ...
                ExtensionRuntime.prototype._getCorrelationId = function (request) {
                    if (request instanceof Commerce.OperationRequest
                        && TypeExtensions_1.ObjectExtensions.isString(request.correlationId)
                        && !TypeExtensions_1.StringExtensions.isNullOrWhitespace(request.correlationId)) {
                        return request.correlationId;
                    }
                    else if (!TypeExtensions_1.ObjectExtensions.isNullOrUndefined(request)
                        && TypeExtensions_1.ObjectExtensions.isString(request[ExtensionRuntime.CORRELATION_ID_FIELD_NAME])
                        && !TypeExtensions_1.StringExtensions.isNullOrWhitespace(request[ExtensionRuntime.CORRELATION_ID_FIELD_NAME])) {
            ...
            exports_1("default", ExtensionRuntime);
        }
    };
});
...
// SIG // Iw8EnkCqWaH7H2FfFRvlvk/mV39zOw8Jw4Ft4Esj2qKg
...
// SIG // ARUwLwYJKoZIhvcNAQkEMSIEIKrCEMj1TJeDVqurSajf
// SIG // DuD6XU0bbaLWvRDoPD5tNDKkMGQGCisGAQQBgjcCAQwx
// SIG // VjBUoDaANABnAGwAbwBiAGEAbABpAHoAZQAuAGMAdQBs
// SIG // AHQAdQByAGUALgBsAHYALQBMAFYALgBqAHOhGoAYaHR0
// SIG // cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEB
// SIG // AQUABIIBAE1IOMnah4cW0Zu9rWpxQcQeqImD2QYfN8jR
// SIG // 7LqQPM4yPa7e2ndvoc/LkB02TsWYG2tOq4kt2ZoRGNX3
// SIG // BC4Qyc8Hf2iv8Gi7LJa+SHcSKNSqI5NA3SPuwayzmmyE
// SIG // ZTXHBW1wgEx4Z1Mc7l3vfeNb7d/+519SQBoKFXFq3vEU
// SIG // 6401fEvLeCtE9iMqDuXGpKU1TZXnGHms7g/G3WtuxWs0
// SIG // HFcG5Xbt4yJvwnMBoKeX19s/6JxU6sfb9mpD2mJhLKPp
// SIG // FlOaLUF7vMSFnQa8PMSIjKkYRM6WAPQtDRoj9/41ecGi
// SIG // HZ79qX3+8Bgt27LeIhmVBJ7KOoPjSVBHsh/xl6RlxACh
...
// SIG // CisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgXzcJ
// SIG // 5bEHsK6cS3bk+1OZcfZuVIMWwc0Xa+vtDUL4a50CBlx1
// SIG // QLrKVBgTMjAxOTAzMTIwOTUzMTIuMDMxWjAEgAIB9KCB
...
// SIG // DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCC4EL5hpd856e+4
// SIG // /fil6o8hvMwEpvn7iylP1N6FiPpSjTCB+gYLKoZIhvcN
...
// SIG // j/AvvnNXQrsyMPEwDQYJKoZIhvcNAQELBQAEggEAHkcR
// SIG // pMf5of8TPV79eS8dg7L2lnEz3Hk68MwIOaDjy56QmYaQ
// SIG // Qp0V9SsVlLwtZrogh2qEoZe5bBifMO+3sXAi3s79twa6
// SIG // lNMu4xz0z+k3eMLRu6Mv9dClRyFinNAiz2oK3TS3fdao
// SIG // ct+P0SaL/umPd2YBltOBL29WheYrX6w6+ExAr003X0uf
// SIG // +NQl5T6EARn+rQLEhRI/2gZlX14/ELnGuP4pGLsgUAUn
// SIG // 1Y/+BBCkJSgzoTpI+LH7DSm3C3x7Tp7Wdh9Z7qGP5qjo
// SIG // SmjXmnAJqcfOgMYfy7y/4s/GUKBnc1A0erqcMV237JB/
// SIG // znR2pZGnPANX+ssFtE7YlnPtMrmNlQ==
