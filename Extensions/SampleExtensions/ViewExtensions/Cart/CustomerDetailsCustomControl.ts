...
export default class CustomerDetailsCustomControl extends CartViewCustomControlBase {
    ...
    public readonly accountHolder: Computed<string>;
    public readonly accountNumber: Computed<string>;
    public readonly phone: Computed<string>;
    public readonly email: Computed<string>;
