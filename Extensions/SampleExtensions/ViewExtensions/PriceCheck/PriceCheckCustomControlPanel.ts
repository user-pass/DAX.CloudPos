...
export default class PriceCheckCustomControlPanel extends PriceCheckCustomControlBase {
    ...
    public readonly customerName: Observable<string>;
    public readonly monthlyProductPrices: ObservableArray<IMonthlyPrice>;
    public readonly dataList: DataList<IMonthlyPrice>;
    ...
    constructor(id: string, context: IPriceCheckCustomControlContext) {
        ...
        this.monthlyProductPrices = ko.observableArray([]);
        this.dataList = new DataList<IMonthlyPrice>({
            columns: [
                {
                    title: "Month",
                    ratio: 50,
            ...
            itemDataSource: this.monthlyProductPrices,
    ...
    private _updateMonthlyProductPrice(productPrice: number): void {
        ...
        let monthlyPaymentAmounts: IMonthlyPrice[] = [
            {
                month: "January",
        ...
        this.monthlyProductPrices(monthlyPaymentAmounts);
    }
