 ...
 */
export default class PrintOperationRequestHandler<TResponse extends PrintOperationResponse> extends ExtensionOperationRequestHandlerBase<TResponse> {
    /**
     ...
     */
    public executeAsync(request: PrintOperationRequest<TResponse>): Promise<ClientEntities.ICancelableDataResult<TResponse>> {
