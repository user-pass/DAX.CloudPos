System.register(["PosApi/Extend/Triggers/TransactionTriggers", "../Managers/PrintAdvanceInvoiceManager", "../Messages/PrintAdvanceInvoiceRequest"], function (exports_1, context_1) {
    "use strict";
    ...
    var Triggers, PrintAdvanceInvoiceManager_1, PrintAdvanceInvoiceRequest_1, PrintAdvanceInvoicePostCartCheckoutTrigger;
    ...
    return {
        ...
        execute: function () {
            PrintAdvanceInvoicePostCartCheckoutTrigger = (function (_super) {
                __extends(PrintAdvanceInvoicePostCartCheckoutTrigger, _super);
                function PrintAdvanceInvoicePostCartCheckoutTrigger() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
                PrintAdvanceInvoicePostCartCheckoutTrigger.prototype.execute = function (options) {
                    var _this = this;
                    if (!PrintAdvanceInvoiceManager_1.default.isAdvanceInvoiceCanBePrinted(options.salesOrder, true)) {
                    ...
                    return PrintAdvanceInvoiceManager_1.default.isAdvanceInvoiceCreatedForDepositAsync(this.context)
                        ...
                        if (isAdvanceInvoiceCreatedForDeposit) {
                            var printAdvanceInvoiceRequest = new PrintAdvanceInvoiceRequest_1.default(_this.context.logger.getNewCorrelationId(), options.salesOrder.SalesId, options.salesOrder.Id, options.salesOrder.StoreId, options.salesOrder.TerminalId);
                            return _this.context.runtime.executeAsync(printAdvanceInvoiceRequest)
                                .then(function () {
                                return Promise.resolve();
                            });
                        }
                ...
                return PrintAdvanceInvoicePostCartCheckoutTrigger;
            }(Triggers.PostCartCheckoutTrigger));
            exports_1("default", PrintAdvanceInvoicePostCartCheckoutTrigger);
        }
    };
});
//# sourceMappingURL=PrintAdvanceInvoicePostCartCheckoutTrigger.js.map
// SIG // Begin signature block
// SIG // MIIjpgYJKoZIhvcNAQcCoIIjlzCCI5MCAQExDzANBglg
// SIG // hkgBZQMEAgEFADB3BgorBgEEAYI3AgEEoGkwZzAyBgor
// SIG // BgEEAYI3AgEeMCQCAQEEEBDgyQbOONQRoqMAEEvTUJAC
// SIG // AQACAQACAQACAQACAQAwMTANBglghkgBZQMEAgEFAAQg
// SIG // V0DjVUklUq2sOeN8Xl4eNlhAxHXNSEyk4bwIFTs7v8yg
...
// SIG // ARUwLwYJKoZIhvcNAQkEMSIEILtNzTdedmnK20RIvCgo
// SIG // Watn6+6OmJI85nf3YPXT4lcdMGQGCisGAQQBgjcCAQwx
// SIG // VjBUoDaANABnAGwAbwBiAGEAbABpAHoAZQAuAGMAdQBs
// SIG // AHQAdQByAGUALgBsAHYALQBMAFYALgBqAHOhGoAYaHR0
// SIG // cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEB
// SIG // AQUABIIBAMsur6zbaCx8dfRiFj/jSxPJ9X7f30uZ3cGO
// SIG // x3pPGE2ZweeiXqgx30Ru8HoAZifflFi4nadxvwP9vY9g
// SIG // 1nZDouTO6/bL0Id19qsjNSQfIr+kF2+Smpk5kwtaYHZn
// SIG // JIPCYN6RkuHWDYlb2LawUZPt4QFtazPdfirjm/pvnOYd
// SIG // UEPlmeVMBO0cefNsVjw3G9l3AbKvpRw7eEgeyl1N/B+g
// SIG // gueVYL3yPPdgHsmFEfrPE6k96B3M57WjHBdV3KBE+DiW
// SIG // ZUomBA45NtT4CPqTTVKsj7W4qtLaPxb6tzQS1sWd29IS
// SIG // 2LlfxaqMvWb1plvuKjwh6tomeI6qOOAlb9cWaql9Guah
...
// SIG // CisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgxDNQ
// SIG // uq4ZesFWNkgp2a8/3niRpsmcid7ssD8QuT590PMCBlx1
// SIG // QL2PnRgTMjAxOTAzMTIwOTUxNTguMjM1WjAEgAIB9KCB
...
// SIG // DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCAjlpDmm7SzNFoY
// SIG // umpBxaNlI4mIbvPJdx6FQVQzEad8ljCB+gYLKoZIhvcN
...
// SIG // GD01vBbMDNurDUgwDQYJKoZIhvcNAQELBQAEggEAjOu1
// SIG // T4GRASj2YHJVWQC33XjluRKlQk+UxU8MsE8/O2jEwB2p
// SIG // BevypQ8ViSqUWW35EcoUK3ki/bb8SOekFV0AR7VhXufc
// SIG // kWR+ROQ1+8MAShfTxh69Qb0+7d5OpkIS8a69ovz8wLiE
// SIG // 6cp9OZLWFemFnJRg4++CbEPjGGKJF1CwoE16ntx443nI
// SIG // LcAM7R0ZCG2kkHMtz2qr+oiiuZSlcUW4S3TwNxeSAl8N
// SIG // LR8FzZgEqK7midV2SwPZZuHjHJ7fab9bMOWen9MUtFGg
// SIG // Mp4N/AYpZz67k5gktrmoazYG0YP+TYyq4Wo1Y7J4Kb1h
// SIG // jsFvriA799r0UwoJekj0FHB4xcqTyA==
