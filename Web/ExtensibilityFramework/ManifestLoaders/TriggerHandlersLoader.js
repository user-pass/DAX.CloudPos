System.register(["PosApi/Extend/Triggers/Triggers", "../Extension", "./ManifestLoaderBase", "../ExtensionNameGenerator"], function (exports_1, context_1) {
    "use strict";
    ...
    var Triggers, Extension_1, ManifestLoaderBase_1, ExtensionNameGenerator_1, TriggersLoader;
    ...
    return {
        ...
        execute: function () {
            TriggersLoader = (function (_super) {
                ...
                function TriggersLoader(loadModuleImpl) {
                    ...
                    Object.keys(Commerce.Triggers.CancelableTriggerType).forEach(function (key) {
                        ...
                        if (value instanceof Commerce.Triggers.CancelableTriggerType) {
                    ...
                    Object.keys(Commerce.Triggers.NonCancelableTriggerType).forEach(function (key) {
                        ...
                        if (value instanceof Commerce.Triggers.NonCancelableTriggerType) {
                ...
                TriggersLoader.prototype._loadTrigger = function (manifestItem, extensionPackage) {
                    ...
                    var extensionName = ExtensionNameGenerator_1.default.getTriggerExtensionName(manifestItem);
                    return Promise.resolve().then(function () {
                        ...
                        return _this.loadModule(extensionPackage.packageInfo.baseUrl, manifestItem.modulePath)
                            ...
                            if (!Commerce.ObjectExtensions.isNullOrUndefined(triggerModule) &&
                                ...
                                if (triggerTypeInstance instanceof Triggers.NonCancelableTriggerType) {
            ...
            exports_1("default", TriggersLoader);
        }
    };
});
//# sourceMappingURL=TriggerHandlersLoader.js.map
// SIG // Begin signature block
// SIG // MIIjpgYJKoZIhvcNAQcCoIIjlzCCI5MCAQExDzANBglg
// SIG // hkgBZQMEAgEFADB3BgorBgEEAYI3AgEEoGkwZzAyBgor
// SIG // BgEEAYI3AgEeMCQCAQEEEBDgyQbOONQRoqMAEEvTUJAC
// SIG // AQACAQACAQACAQACAQAwMTANBglghkgBZQMEAgEFAAQg
// SIG // iGkvJghP0qZ2kgUCSmQqZWepfwFAwLbcPIMSnSIHbKGg
...
// SIG // ARUwLwYJKoZIhvcNAQkEMSIEIPxhW7bBKPMR9kkFyGFE
// SIG // h2rPKRaPdpvv5EQIKUpppXgkMGQGCisGAQQBgjcCAQwx
// SIG // VjBUoDaANABnAGwAbwBiAGEAbABpAHoAZQAuAGMAdQBs
// SIG // AHQAdQByAGUALgBsAHYALQBMAFYALgBqAHOhGoAYaHR0
// SIG // cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEB
// SIG // AQUABIIBANBaO9hZZAT1emkGFE56HfjdxpJ8lEAhDyKe
// SIG // gjV14z4nRfku8P//doCOUJnToC0k9jYqOZ7NEGqTOGHR
// SIG // Cwin2mAgK6HDoMf/as5hPDq9c0H8aZflbexqfe7Zhc0A
// SIG // mhxA8eRKMX+Np5T+LzztsNJj/SMEPNpIb4Jv5r7x7NSy
// SIG // wKAR7YT78o1m8qa8Rfsk2Psh/K+tPOgw2SONNlPfkYv6
// SIG // Un8GEU8pnUsT+eEmHKX2uNiNvJx3qGfp6UsHAEUiC40s
// SIG // DYdIjwF48kGJd0Pa/C2ET/2iYdCguAc36hFqR7YOn2I5
// SIG // 6C9VQQAq5w05p9g9Busp9u+nmS9MXRqEluS2ZBe2oQSh
...
// SIG // CisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgWiRE
// SIG // SeB/gYWg6NCxcBFQMheSbK7pb1UdPcATCKwxMjkCBlx1
// SIG // QLrKNBgTMjAxOTAzMTIwOTUzMTAuOTA4WjAEgAIB9KCB
...
// SIG // DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCCR8k0t2y0XdUV8
// SIG // QvY1z3k3WtGQNSFDWgTgaugTtSjV+TCB+gYLKoZIhvcN
...
// SIG // j/AvvnNXQrsyMPEwDQYJKoZIhvcNAQELBQAEggEAhuxo
// SIG // GXyQcrtE6REP1GytJuAb5jMYwUQWlwsXY+MBSHfKlNol
// SIG // HRrMrQlPcfbttlQpBrrlagVBm1uSlDMbrfP1SmRW5heN
// SIG // ib4Sx9nl6JZoC3lzlQ0wxTFQ73mcAX/LSqnZ27RiUNdv
// SIG // 6gcKp/f9QrvBkVkC8NALrSr7Kqv4GFsRyAU2J9b3KksR
// SIG // 3H15QH1sYFQ+0JT1p9thi5DUgVZ2+cOOOOfEYe0z+DuS
// SIG // FSyNnquF7bvVCG+2sxYLSebyYOvr3PF7ep1Fgt7wIXTF
// SIG // oKfCc0bJ/cxBhA58peFAhoeNKEeLzBRO1BELWHd+HXhY
// SIG // l5+nQ+C6XefXtT3ZSs8extz03oponQ==
