System.register(["PosApi/Entities", "PosApi/TypeExtensions", "PosApi/Extend/Triggers/PrintingTriggers", "../Managers/AuditEventRegistrationManager"], function (exports_1, context_1) {
    "use strict";
    ...
    var Entities_1, TypeExtensions_1, Triggers, AuditEventRegistrationManager_1, PrePrintReceiptCopyTrigger;
    ...
    return {
        ...
        execute: function () {
            PrePrintReceiptCopyTrigger = (function (_super) {
                __extends(PrePrintReceiptCopyTrigger, _super);
                function PrePrintReceiptCopyTrigger() {
                    return _super !== null && _super.apply(this, arguments) || this;
                }
                PrePrintReceiptCopyTrigger.prototype.execute = function (options) {
                    var salesReceiptCopyIsPrinted = options.receiptAndPrinterPairs.some(function (pair) {
                    ...
                    if (salesReceiptCopyIsPrinted) {
                        var auditEventManager_1 = new AuditEventRegistrationManager_1.AuditEventRegistrationManager(this.context);
                        return auditEventManager_1.updateAndPrintReceipts(options.salesOrder, options.receiptAndPrinterPairs)
                            .then(function () {
                            return auditEventManager_1.registerPrintReceiptCopyAsync(options.salesOrder);
                        })
                            .then(function () {
            ...
            }(Triggers.PrePrintReceiptCopyTrigger));
            exports_1("default", PrePrintReceiptCopyTrigger);
        }
    };
});
//# sourceMappingURL=PrePrintReceiptCopyTrigger.js.map
// SIG // Begin signature block
// SIG // MIIjpgYJKoZIhvcNAQcCoIIjlzCCI5MCAQExDzANBglg
// SIG // hkgBZQMEAgEFADB3BgorBgEEAYI3AgEEoGkwZzAyBgor
// SIG // BgEEAYI3AgEeMCQCAQEEEBDgyQbOONQRoqMAEEvTUJAC
// SIG // AQACAQACAQACAQACAQAwMTANBglghkgBZQMEAgEFAAQg
// SIG // 5sGcCCixrUc4eyyAxe70mMLm2KN7qUEjRUw3FtCggyig
...
// SIG // ARUwLwYJKoZIhvcNAQkEMSIEIHklJsSj3xAQ1cyxcgHQ
// SIG // Gz37pkp9QUEEC7yitJdjyKlKMGQGCisGAQQBgjcCAQwx
// SIG // VjBUoDaANABnAGwAbwBiAGEAbABpAHoAZQAuAGMAdQBs
// SIG // AHQAdQByAGUALgBsAHYALQBMAFYALgBqAHOhGoAYaHR0
// SIG // cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEB
// SIG // AQUABIIBALF4lh9H2+zIz15P/H5hEfqtYyoKdFU6D2FF
// SIG // EbzvSJ9oSiXQzjwMYqU7xnz5XfrFVuL3vFeVVapkxpvX
// SIG // iDXdu1S096LHylANHl+CNe3L2UGCbeCVkM/Jg242WJhk
// SIG // DGrWmd9SgT4FZSHo3X1kWnZWZBt1+zSzGQuzYr+dnllj
// SIG // P8DwN6K9Pb0kI5U8j6D1re2I6OmWql+spHrpMjj6AJvx
// SIG // +W0yex1JaSe6yPGL/NiEKsJ4+Ttom0YnEQhGMebfUHkw
// SIG // yR4p6sC5mqho8tA3Ap+gG9PqJadvMBvQRbVKMDsO1ztA
// SIG // YI2r5OHmNtz5JmISe9k6irqqgzGFsJXcfzY3aLWVFrmh
...
// SIG // CisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgow3P
// SIG // 6RC5FOxXSSXTA3ICDkDFYaIz07uwgGv4pjL1DSoCBlx1
// SIG // QLrDzxgTMjAxOTAzMTIwOTUxNTYuMzg5WjAEgAIB9KCB
...
// SIG // DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCCmLk80xMR7ZUkN
// SIG // wkfXhLWzqeNsVt/I/xsaFPH0ACmlQDCB+gYLKoZIhvcN
...
// SIG // j/AvvnNXQrsyMPEwDQYJKoZIhvcNAQELBQAEggEAis7K
// SIG // mF0Eygk6fmJj4xqsYyKbKZjWt1fG4Eq/mmree3LR04tc
// SIG // 5I93itX+X7eJWYntLAN3TK9yiMKN/P6UXO5fOSgW98ok
// SIG // bwet1FG5pNVfAuEF3CCImO2PXfSI1cJDEqJvoRtYISr+
// SIG // IMmmiMRyyW8G8gtWf7U667sLkWcGgrKgK1GwAe/R5Cn5
// SIG // 6Iis3BkyOEyACLJ0BreSSWnxl+swnu2G3ZxghQjGg4Dy
// SIG // Ehd/BBU2M5oh/lL3mx1eTTFIWXIUshYmNEp/prpEk41e
// SIG // ghEE3VFJyack3M0g7dj8Dg5oDhbklAC+VnRvWnrj1ruQ
// SIG // D6gZoM+oj8+SUzxWjsmWidqbvBAKXQ==
