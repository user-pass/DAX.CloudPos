System.register(["PosApi/Consume/Dialogs", "PosApi/Entities", "PosApi/Extend/Views/ShowJournalView", "PosApi/TypeExtensions", "../../Managers/PrintAdvanceInvoiceManager", "../../Messages/PrintAdvanceInvoiceRequest"], function (exports_1, context_1) {
    "use strict";
    ...
    var Dialogs_1, Entities_1, ShowJournalView, TypeExtensions_1, PrintAdvanceInvoiceManager_1, PrintAdvanceInvoiceRequest_1, PrintAdvanceInvoiceCommand;
    ...
    return {
        ...
        execute: function () {
            PrintAdvanceInvoiceCommand = (function (_super) {
                __extends(PrintAdvanceInvoiceCommand, _super);
                function PrintAdvanceInvoiceCommand(context) {
                    var _this = _super.call(this, context) || this;
                    _this._isAdvanceInvoiceCreatedForDeposit = undefined;
                    _this.id = "printAdvanceInvoiceCommand";
                    _this.label = context.resources.getString("Print_Advance_Invoice");
                    _this.extraClass = "iconPrint";
                    ...
                    _this.receiptSelectionClearedHandler = function () {
                        _this._isPrintingAvailableAsync()
                            .then(function (isPrintingAvailable) {
                            _this.isVisible = isPrintingAvailable;
                        });
                    };
                    return _this;
                }
                PrintAdvanceInvoiceCommand.prototype.init = function (state) {
                    var _this = this;
                    this._mode = state.mode;
                    this._isPrintingAvailableAsync()
                        .then(function (isPrintingAvailable) {
                        _this.isVisible = isPrintingAvailable;
                    });
                };
                PrintAdvanceInvoiceCommand.prototype.execute = function () {
                    var _this = this;
                    this.isProcessing = true;
                    var printAdvanceInvoiceRequest = new PrintAdvanceInvoiceRequest_1.default(this.context.logger.getNewCorrelationId(), this._selectedJournal.SalesId, TypeExtensions_1.StringExtensions.EMPTY, TypeExtensions_1.StringExtensions.EMPTY, TypeExtensions_1.StringExtensions.EMPTY);
                    this.context.runtime.executeAsync(printAdvanceInvoiceRequest)
                        .then(function () {
                        _this.isProcessing = false;
                    })
                        .catch(function (errors) {
                        _this.isProcessing = false;
                        _this._showErrorMessage(errors);
                    });
                };
                PrintAdvanceInvoiceCommand.prototype._journalChanged = function (data) {
                    this._selectedJournal = data.salesOrder;
                    this.canExecute = PrintAdvanceInvoiceManager_1.default.isAdvanceInvoiceCanBePrinted(data.salesOrder, false);
                };
                PrintAdvanceInvoiceCommand.prototype._isPrintingAvailableAsync = function () {
                    var _this = this;
                    if (this._mode !== Entities_1.ClientEntities.ShowJournalMode.ShowJournal) {
                        return Promise.resolve(false);
                    }
                    if (!TypeExtensions_1.ObjectExtensions.isUndefined(this._isAdvanceInvoiceCreatedForDeposit)) {
                        return Promise.resolve(this._isAdvanceInvoiceCreatedForDeposit);
                    }
                    return PrintAdvanceInvoiceManager_1.default.isAdvanceInvoiceCreatedForDepositAsync(this.context)
                        .then(function (isAdvanceInvoiceCreatedForDeposit) {
                        _this._isAdvanceInvoiceCreatedForDeposit = isAdvanceInvoiceCreatedForDeposit;
                        return Promise.resolve(_this._isAdvanceInvoiceCreatedForDeposit);
                    });
                };
                PrintAdvanceInvoiceCommand.prototype._showErrorMessage = function (errors) {
                    var message = TypeExtensions_1.StringExtensions.EMPTY;
                    if (TypeExtensions_1.ArrayExtensions.hasElements(errors)) {
                        message = errors.map(function (error) {
                            return error.localizedMessage;
                        }).join(" ");
                    }
                    var showMessageDialogClientRequestOptions = {
                        title: this.context.resources.getString("Error"),
                        subTitle: this.context.resources.getString("Advance_Invoice_Printing_Error"),
                        message: message
                    };
                    var showMessageDialogClientRequest = new Dialogs_1.ShowMessageDialogClientRequest(showMessageDialogClientRequestOptions);
                    this.context.runtime.executeAsync(showMessageDialogClientRequest);
                };
                return PrintAdvanceInvoiceCommand;
            }(ShowJournalView.ShowJournalExtensionCommandBase));
            exports_1("default", PrintAdvanceInvoiceCommand);
        }
    };
});
//# sourceMappingURL=PrintAdvanceInvoiceCommand.js.map
// SIG // Begin signature block
// SIG // MIIjpgYJKoZIhvcNAQcCoIIjlzCCI5MCAQExDzANBglg
// SIG // hkgBZQMEAgEFADB3BgorBgEEAYI3AgEEoGkwZzAyBgor
// SIG // BgEEAYI3AgEeMCQCAQEEEBDgyQbOONQRoqMAEEvTUJAC
// SIG // AQACAQACAQACAQACAQAwMTANBglghkgBZQMEAgEFAAQg
// SIG // 2UsB78AiV2fFYykoQSk7SzgiRacnI6T5tNFugpvbNpqg
...
// SIG // ARUwLwYJKoZIhvcNAQkEMSIEIM/BFt1/YQXmASelpNhc
// SIG // pAPgPoiTcl0OwjpaJedZmYa6MGQGCisGAQQBgjcCAQwx
// SIG // VjBUoDaANABnAGwAbwBiAGEAbABpAHoAZQAuAGMAdQBs
// SIG // AHQAdQByAGUALgBsAHYALQBMAFYALgBqAHOhGoAYaHR0
// SIG // cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEB
// SIG // AQUABIIBAEnoVJBRSvf+JVW3fqZwBm9XhuXHgwgTJZct
// SIG // cNxuSF8Vth6/8et86LFarCdB2FJfvE6NDEKhM8S9/NBa
// SIG // CDYy5a+G5rIfzzaJ8lokq0eAoA+6biefqe33tvqKEd+a
// SIG // IBbRdnVFEUbSVZszJCO6cmwjazPZzp2sO1pJYBG2geUP
// SIG // 1fSUdAS9+A3CBS+7QQcw2sLDqrOgvUvgXZftFF+qIoMO
// SIG // maBir9IB8EEfs890OkK6yQLOJ7WEvtlc0UiMTAs9+hN4
// SIG // ZWKvBr2FBloo85IpNvTD3JDZbNlUi200Gyh4YDWLt229
// SIG // TWKAGvxHkZR6I2bJQsXnJ/7u3oqx/ijMlF1QtV2b0xih
...
// SIG // CisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgmRJk
// SIG // NWR32FoJ1pHywWP3bA9Z1FSZ8n2dLE5pjQGEAcECBlx1
// SIG // IwwSWRgTMjAxOTAzMTIwOTUxNTguMjMyWjAEgAIB9KCB
...
// SIG // DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCCRZJSTFQ2Lckgw
// SIG // VzhSiPe0oz3XVNRqZRSHIaRWF+7qPjCB+gYLKoZIhvcN
...
// SIG // gvA1VXZaTvCicr8wDQYJKoZIhvcNAQELBQAEggEAffm5
// SIG // Db2llySyd0ZXqbPxz8Ecx1Ano4cSP/Mb9sQPSRMtY9G5
// SIG // atBHAdLsgurAatsQ8wetJTUr19Hv8KH/w7F8Bj2k+vGU
// SIG // Rmh+5m0/wrk5A4jPIR0lkNcb1Xft9DPCaFjNZTozqnrd
// SIG // HTN6/pwAzRvSPMwuu0RtK/q3U2yOnUyYtLxI6IvlFSu4
// SIG // /XpFqvnwJVcz5xUzIqwzEqOP625xjsDX9Rb8lJ55Ga6g
// SIG // tGiAms6/mYuv1+ocoxNBUPHnW92j1PGCP3QmAUbDqjMe
// SIG // Nv26hDmlUY57FC7WHpla0ZeggRzCUNnh6mrifqEuNRkk
// SIG // 3WSCsHFyRmv4Bhf4IdfSP13nJbI29g==
