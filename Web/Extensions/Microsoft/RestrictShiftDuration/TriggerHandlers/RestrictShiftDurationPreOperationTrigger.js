System.register(["PosApi/Extend/Triggers/OperationTriggers", "PosApi/Entities", "../Managers/ShiftClosingChecker"], function (exports_1, context_1) {
    "use strict";
    ...
    var Triggers, Entities_1, ShiftClosingChecker_1, RestrictShiftDurationPreOperationTrigger;
    ...
    return {
        ...
        execute: function () {
            RestrictShiftDurationPreOperationTrigger = (function (_super) {
                __extends(RestrictShiftDurationPreOperationTrigger, _super);
                function RestrictShiftDurationPreOperationTrigger() {
                    var _this = _super !== null && _super.apply(this, arguments) || this;
                    _this.checkedOperations = [
                        Entities_1.ProxyEntities.RetailOperation.AddToGiftCard,
                        Entities_1.ProxyEntities.RetailOperation.IssueGiftCertificate,
                        Entities_1.ProxyEntities.RetailOperation.ItemSale,
                        Entities_1.ProxyEntities.RetailOperation.RecallSalesOrder,
                        Entities_1.ProxyEntities.RetailOperation.RecallTransaction,
                        Entities_1.ProxyEntities.RetailOperation.ReturnItem
                    ];
                    return _this;
                }
                RestrictShiftDurationPreOperationTrigger.prototype.execute = function (options) {
                    var isOperationChecked = this.checkedOperations.some(function (operation) {
                        return operation === options.operationRequest.operationId;
                    });
                    if (isOperationChecked) {
                        return new ShiftClosingChecker_1.ShiftClosingChecker(this.context).checkShouldCancelWorkflowAsync(true).then(function (shouldCancel) {
                            return {
                ...
                return RestrictShiftDurationPreOperationTrigger;
            }(Triggers.PreOperationTrigger));
            exports_1("default", RestrictShiftDurationPreOperationTrigger);
        }
    };
});
//# sourceMappingURL=RestrictShiftDurationPreOperationTrigger.js.map
// SIG // Begin signature block
// SIG // MIIjpgYJKoZIhvcNAQcCoIIjlzCCI5MCAQExDzANBglg
// SIG // hkgBZQMEAgEFADB3BgorBgEEAYI3AgEEoGkwZzAyBgor
// SIG // BgEEAYI3AgEeMCQCAQEEEBDgyQbOONQRoqMAEEvTUJAC
// SIG // AQACAQACAQACAQACAQAwMTANBglghkgBZQMEAgEFAAQg
// SIG // R3Zw+amhdhCDjKrPyE20kOxhiqTwlR5USFlcCXa2ocWg
...
// SIG // ARUwLwYJKoZIhvcNAQkEMSIEIF4xqk2Sdh4TESYxJ7Qw
// SIG // 4aaPDE1D8CqZyzqbtowwR73fMGQGCisGAQQBgjcCAQwx
// SIG // VjBUoDaANABnAGwAbwBiAGEAbABpAHoAZQAuAGMAdQBs
// SIG // AHQAdQByAGUALgBsAHYALQBMAFYALgBqAHOhGoAYaHR0
// SIG // cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEB
// SIG // AQUABIIBAGX53MH32iuMFl0TIxDUg/g+dQ88IGa9TXb4
// SIG // CTI53ulLa0kTcRraYnuiQaO94osCuaELK1YeqLq2yDIN
// SIG // Fao9XTWHR2fYz9QjCDXAqae8TC2SAAhH3dG2C1PoplmB
// SIG // FcyrXWgnx7rpX90E+ZQTRJESLIkFxCSLK/DrVxDtsru5
// SIG // ST5I0DA2hNcSfZgXDmSt5BcYlbayfRnsXl0Th10rQtpT
// SIG // JG924mB0AHFZzS5d9khQqqSVEF3AjweO12+zp36hL/8l
// SIG // ls03iPwdHNALT1DhXJehs8rkR6S8V+LtMomhSNL1YMrs
// SIG // C47+BKMKXef+9yxkoaNX8nLw6IscA1KS+mduBjJ1Rt2h
...
// SIG // CisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgfBUh
// SIG // 9xFrVml4N66rVVVCA08FouQU8BD2Zb/9ZwyobuMCBlx1
// SIG // QL2PAhgTMjAxOTAzMTIwOTUxNTMuMzgxWjAEgAIB9KCB
...
// SIG // DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCA2lO5V35gQhHwq
// SIG // qSsAJejlVmBE4vS18wjozO9MEglXBzCB+gYLKoZIhvcN
...
// SIG // GD01vBbMDNurDUgwDQYJKoZIhvcNAQELBQAEggEAy1pT
// SIG // nEwv4yLo443TgikCGHBoYnlpE5bxlQCFpsBcymdd00Em
// SIG // C1DtUP3o8BZdA+TXrHsu6FZ0e5v9tiESfRZIMiZrBM5M
// SIG // wGR8jZgxMRiJRAjOQ7ibeiYrq6mxkunZ2MfuykrY8tWc
// SIG // YPRKCLA74gXYH7SzL0BAojZICZjdZWjYbiNv+aOy6lAW
// SIG // QJ2GvJZH3m2qmqfecun3l9aaxshumzIcDjitjHgeS2Au
// SIG // T5YfFA1IP/vZZPJEuciKctHA3qQCqt9bk7R8RMhbJQRi
// SIG // 1GUXWZjLm0xdT6sgWm9AepNDETet2gz+L59vos0BNa42
// SIG // WeBy+Jd9H/28KuegPK+1XL1D37Ou9w==
