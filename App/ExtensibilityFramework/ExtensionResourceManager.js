System.register([], function (exports_1, context_1) {
    "use strict";
    var ExtensionResourceManager;
    var __moduleName = context_1 && context_1.id;
    return {
        setters: [],
        execute: function () {
            ExtensionResourceManager = (function () {
                function ExtensionResourceManager(packageId, supportedUICultures, fallbackUICulture, culturesDirectoryPath, stringResourcesFileName) {
                    ...
                    this._fallbackExtensionUICulture = fallbackUICulture;
                    this._stringResourceHelper = new Commerce.StringResourcesHelper(supportedUICultures, culturesDirectoryPath, stringResourcesFileName);
                }
                ExtensionResourceManager.prototype.setCultures = function (culture, uiCulture) {
                    ...
                    return this._stringResourceHelper.loadResourcesAsync(uiCulture, this._defaultApplicationUICulture)
                        .then(function (result) {
                        if (!result.canceled) {
                            _this._stringResources = result.data;
                        }
                        ...
                        return _this._stringResourceHelper.loadResourcesAsync(_this._fallbackExtensionUICulture, _this._fallbackExtensionUICulture);
                    }).then(function (result) {
                ...
                ExtensionResourceManager.prototype.getString = function (stringId) {
                    ...
                    var localizedString = this._stringResources[stringId];
                    if (Commerce.ObjectExtensions.isNullOrUndefined(localizedString)) {
                        return stringId;
                    }
                    return localizedString;
                };
                ExtensionResourceManager.prototype.getCurrentUICulture = function () {
                    return this._stringResourceHelper.getCurrentUICulture();
                };
            ...
            exports_1("ExtensionResourceManager", ExtensionResourceManager);
        }
    };
});
//# sourceMappingURL=ExtensionResourceManager.js.map
// SIG // Begin signature block
// SIG // MIIjpgYJKoZIhvcNAQcCoIIjlzCCI5MCAQExDzANBglg
// SIG // hkgBZQMEAgEFADB3BgorBgEEAYI3AgEEoGkwZzAyBgor
// SIG // BgEEAYI3AgEeMCQCAQEEEBDgyQbOONQRoqMAEEvTUJAC
// SIG // AQACAQACAQACAQACAQAwMTANBglghkgBZQMEAgEFAAQg
// SIG // 4RBDjjao9JnY94lFTMnnFao9Cq1dRhIE+wLffKd3SmWg
...
// SIG // ARUwLwYJKoZIhvcNAQkEMSIEIIbO+fIwPal0xGHQ/eV6
// SIG // pd9eheAzMh+EJSkIQaEBgbvyMGQGCisGAQQBgjcCAQwx
// SIG // VjBUoDaANABnAGwAbwBiAGEAbABpAHoAZQAuAGMAdQBs
// SIG // AHQAdQByAGUALgBsAHYALQBMAFYALgBqAHOhGoAYaHR0
// SIG // cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEB
// SIG // AQUABIIBAHdFcCZDxRCVR5lOcc0NKwhm5qbComvYeZv6
// SIG // iHijXvYlSqvIxqq6xuQRhZ9fVMM4HMRobLjBXefEx84H
// SIG // 5z1xtqzbXB8iNbZog4dKkSIFdZFOk0OsBNq1zQK7wjZX
// SIG // W647q1/AMGUau/jXbFjwnk2WtetjPUuc6WFJjwFZeylt
// SIG // K8UxXi52XSlO70Kmy1mOF+5txEh9DcNfrNWX87h34gpI
// SIG // 9/GntonIygt7DoAymzd+siVgZAiCxy5OJKpUyWnAQlKD
// SIG // SKZIrgxRLfde+qQp9USL9qIx/zGxC5x06sy+w5OgFE20
// SIG // vjDAaxYMzj3Xh5RLWIh4EgEsZx1yKmHHPjgDex4UgTOh
...
// SIG // CisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgJeu4
// SIG // fYGLvppIWUgNfD+Xoqu+w3y8brL+e8SkSjG9faYCBlx1
// SIG // QL2VXhgTMjAxOTAzMTIwOTUzMTMuMDA2WjAEgAIB9KCB
...
// SIG // DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCCLzzKnAOk1KPpU
// SIG // Fv/grl7TALqN1rXXkWJMEFIuac0H8DCB+gYLKoZIhvcN
...
// SIG // GD01vBbMDNurDUgwDQYJKoZIhvcNAQELBQAEggEABXs4
// SIG // VMTfbLWaWD2R9lhCykeKIuI+pluxJ4qxQSpxjWrh+8Sb
// SIG // rMBALOJbRp+Ok1/c5bzuYf65VMa47eBiC4KWwFGvo0SK
// SIG // N8CAXG545pC1NloxRM2fsWK6WoKipvOxTbkFiUJ4/XDf
// SIG // qZzW1dUSkGWWTZQZre6JoFHSMawUE9Votjc4kaKih8AG
// SIG // TXVr6uUOs+yfL/2eLBMdlMFDhrS4rmGdM4RbeNleAxlj
// SIG // ld72YR0ABwPfcGQNVeGDncPR0ybZJSVC8WM30VKGJQKy
// SIG // Bs+S8u0LVsVVGmXyGFz9vBd9OPhhw6QpjlpIR6GeM4s8
// SIG // EH8pBGdSczfNmvTMEM53lBgJMH9bcA==
