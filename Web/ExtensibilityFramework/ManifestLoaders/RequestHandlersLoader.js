System.register(["PosApi/Create/RequestHandlers", "../Extension", "./ManifestLoaderBase", "../ExtensionNameGenerator"], function (exports_1, context_1) {
    "use strict";
    ...
    var RequestHandlers_1, Extension_1, ManifestLoaderBase_1, ExtensionNameGenerator_1, ExtensionPointType, RequestHandlersLoader;
        ...
        execute: function () {
            ...
            RequestHandlersLoader = (function (_super) {
                ...
                RequestHandlersLoader.prototype._loadHandler = function (extensionPackage, handler, correlationId) {
                    ...
                    var extensionName = ExtensionNameGenerator_1.default.getNewRequestHandlerExtensionName(handler);
                    return this.loadModule(extensionPackage.packageInfo.baseUrl, handler.modulePath)
                        ...
                        if (Commerce.ObjectExtensions.isNullOrUndefined(handlerModule) || Commerce.ObjectExtensions.isNullOrUndefined(handlerModule.default)) {
                            Commerce.RetailLogger.extensibilityFrameworkInvalidModuleWhileLoadingRequestHandlers(handler.modulePath, correlationId);
                            var loadError = new Error("Invalid module");
                            return Promise.reject(loadError);
                        }
                        else if (!(handlerModule.default.prototype instanceof RequestHandlers_1.ExtensionRequestHandlerBase)) {
                            Commerce.RetailLogger.extensibilityFrameworkTypeMismatchWhileLoadingRequestHandlers(handler.modulePath, "ExtensionRequestHandlerBase", correlationId);
                        ...
                        return extensionPackage.context.runtime.executeAsync(request).then(function () {
                            Commerce.RetailLogger.extensibilityFrameworkRequestHandlerSuccessfullyRegistered(handler.modulePath, correlationId);
                            extensionPointName = handler.modulePath;
                        });
                    }).then(function () {
                        ...
                        Commerce.RetailLogger.extensibilityFrameworkRequestHandlerFailedToRegister(handler.modulePath, Commerce.ErrorHelper.serializeError(reason), correlationId);
            ...
            exports_1("default", RequestHandlersLoader);
        }
    };
});
//# sourceMappingURL=RequestHandlersLoader.js.map
// SIG // Begin signature block
// SIG // MIIjpgYJKoZIhvcNAQcCoIIjlzCCI5MCAQExDzANBglg
// SIG // hkgBZQMEAgEFADB3BgorBgEEAYI3AgEEoGkwZzAyBgor
// SIG // BgEEAYI3AgEeMCQCAQEEEBDgyQbOONQRoqMAEEvTUJAC
// SIG // AQACAQACAQACAQACAQAwMTANBglghkgBZQMEAgEFAAQg
// SIG // sIPuNvOsGUJgidd9IFrOVbK6x9JWR/0x67Iy6ruYVt2g
...
// SIG // ARUwLwYJKoZIhvcNAQkEMSIEIPNgKywhODyiCUO7zd6v
// SIG // PILPBHTabyGEgoYma5/1rn2ZMGQGCisGAQQBgjcCAQwx
// SIG // VjBUoDaANABnAGwAbwBiAGEAbABpAHoAZQAuAGMAdQBs
// SIG // AHQAdQByAGUALgBsAHYALQBMAFYALgBqAHOhGoAYaHR0
// SIG // cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEB
// SIG // AQUABIIBAGDh53NtUmsh1DQBUyG+idbR4FbRYQGS/z5n
// SIG // C/1G3dGIWWzVqIsTEpMWYZ7jyWrfGMaY3mHrknb5OwFT
// SIG // Gsm9mz7mu1ldoA3akBstUZvcXi2AeAlgkO1xGqZ7DBL6
// SIG // NZLMBNAMWk9EQVJbyJBESAwBeo9zooe8FHlJbrRo0Y63
// SIG // LpJDMKjYl7vAlv3RwY3Mqs+PUgQswWpMAOhQ+DbEfimn
// SIG // YsGndXSqYlx1ATThZt2RGSbeOEQhDiJy49CXGItZlyqb
// SIG // qaw3dzRpuR0LbU6dl/7XRaWJJbUHWEUw2++aEBF7e8vG
// SIG // WBDbNjOmfREoBLFLNXO91x3aBjZNeAmIvoi5UlmKBM+h
...
// SIG // CisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgVXIM
// SIG // KpfBg0zYHbNF27Uy9rgQOQXABQjteKglnyqF1ScCBlx1
// SIG // QL2VAhgTMjAxOTAzMTIwOTUzMTAuMzQ4WjAEgAIB9KCB
...
// SIG // DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCCY0ObM0he7ewCe
// SIG // Nhpie+ruZomQaWPAkO+pNJqzk66bbjCB+gYLKoZIhvcN
...
// SIG // GD01vBbMDNurDUgwDQYJKoZIhvcNAQELBQAEggEAtmTg
// SIG // yXZ1y5KjvVnFNEy4R1/ElyIvwIHOtWXQevnCgISaVBAJ
// SIG // VhgQhPbvPVwXcmONj7+jOpNF7wCrPd6QhI3v8jOrRY6u
// SIG // aUwokTzTqt/Yj/YooLb9QISF6lY8yN3OfLZpMIgAdCH/
// SIG // 9EvHxw/zl+elWS/uX42dFtSAZGe6bozlY3VlkYS7EqWe
// SIG // HYrUUllyl82n7WTnJl8mDT+CehABz9pMeO9LZU/y5NIy
// SIG // lhpTzxL9iqK0jmhXVyBE9XBg3wiQdBHOSKT8JtPuMTMG
// SIG // 36E3kAXhoNGd/ILX5zskLShd5dKvOvCLDKyxfm++Iim+
// SIG // c9DA1YvMCuZrir1Lb0PHTOFmemK9Pw==
